//
//  GameScene.swift
//  85.Day-Project26-MarbleMaze
//
//  Created by Sabir Myrzaev on 07.02.2022.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func createSuperStar(_ position: CGPoint) {
        let node = SKSpriteNode(imageNamed: "star")
        node.name = "superstar"
        node.color = .systemPurple
        node.setScale(0.5)
    ...
    func createWall(_ position: CGPoint) {
