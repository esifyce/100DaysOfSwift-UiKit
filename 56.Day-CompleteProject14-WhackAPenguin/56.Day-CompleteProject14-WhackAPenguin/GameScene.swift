//
//  GameScene.swift
//  55.Day-Project14-WhackAPenguin
//
...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        gameScore = SKLabelNode(fontNamed: "Roboto")
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for node in tappedNodes {
            ...
            if node.name == "charFriend" {
                // should't have whacked this penguin
                score -= 5
    ...
    func createEnemy() {
        ...
        if numRounds >= 30 {
            ...
            gameScore.fontSize = 64
            gameScore.position = CGPoint(x: 512, y: 290)
